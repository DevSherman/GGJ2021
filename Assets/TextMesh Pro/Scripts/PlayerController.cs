...
public class PlayerController : MonoBehaviour
{
    ...
    void HandleCharacterMovement()
    {
        // horizontal character rotation
        {
            ...
            transform.Rotate(new Vector3(0f, (Input.GetAxisRaw("Mouse X") * 1f * 0.05f  * rotationSpeed * RotationMultiplier), 0f), Space.Self);
        }

        // vertical camera rotation
        {
            // add vertical inputs to the camera's vertical angle
            m_CameraVerticalAngle += Input.GetAxisRaw("Mouse Y") * 1f * 0.05f * rotationSpeed * RotationMultiplier;
